...
To demonstrate the technique, you can download the [executable jar][4] for the project and execute it. Alternatively, you can download the project and build it then execute/modify the example from class [ScenarioExecutor.java][11].
...
To demonstrate the technique, you can download the [executable jar][4] for the project and execute the provided example. Alternatively, you can download the project and build it then execute/modify the example from class [ScenarioExecutor.java][11].
